...
const centerFeature: Feature = {
  ...
  desc: "Reliable & scalable energy backup.",
};
...
/* ---------- CARD COMPONENT (Uniform Size FIX) ---------- */
const FeatureCard: React.FC<{ feature: Feature }> = ({ feature }) => (
  ...
  >
    {/* ICON */}
    <div className="w-14 h-14 sm:w-16 sm:h-16 mb-4 rounded-xl bg-gradient-to-br from-blue-100 to-orange-100 flex items-center justify-center">
      <Image src={feature.icon} alt={feature.label} width={38} height={38} />
    </div>
    ...
    {/* Hover Border Effect */}
    <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-blue-500 transition-all duration-300 pointer-events-none" />
  </motion.div>
);
          ...
          <div className="flex flex-col items-center">
            <div className="relative mb-6 lg:mb-8">
              <div className="relative w-56 h-56 lg:w-64 lg:h-64 rounded-2xl overflow-hidden border border-gray-200 shadow-xl">
                <Image src={bag} alt="Technology solutions" fill className="object-cover" />
            ...
            <motion.div whileHover={{ scale: 1.05 }} className="mt-6 w-full max-w-[260px] mx-auto">
              <Link
                href="/products"
                className="bg-blue-100 text-blue-800 font-semibold px-6 py-3 md:py-4 rounded-xl shadow-md hover:bg-blue-200 hover:shadow-lg transition block text-center"
              >
                View All Solutions
              </Link>
            </motion.div>
