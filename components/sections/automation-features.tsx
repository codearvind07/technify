...
const features = [
  {
    ...
    description: 'Automate repetitive tasks and workflows to increase productivity and reduce human error.',
    icon: (
  ...
  },
  {
    ...
    description: 'Advanced control systems for manufacturing and industrial processes.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Connect your equipment with intelligent sensors for real-time monitoring and data collection.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a1 1 0 001-1v-2a1 1 0 00-1-1H8a1 1 0 00-1 1v2a1 1 0 001 1z" />
  ...
  },
  {
    ...
    description: 'Use AI and machine learning to predict equipment failures before they happen.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Ensure consistent product quality with automated inspection and control systems.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
