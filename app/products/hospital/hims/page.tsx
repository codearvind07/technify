  ...
  const features = [
    {
      ...
      description: "Centralized and secure storage of comprehensive patient medical records and history."
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      description: "Digital health records for improved accessibility and accuracy in patient care."
    },
    {
      icon: Users,
      title: "Staff Management",
      description: "Comprehensive management of healthcare staff schedules, roles, and responsibilities."
    }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Hospital Information Management System featuring patient data management, appointment scheduling, electronic health records, and staff management for improved healthcare delivery."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Healthcare Information Solution
                  </motion.div>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/hospital-hims-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Hospital Information Management</h3>
                        <p className="mt-2 opacity-90">Streamlined Healthcare Operations</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                  Advanced Information Management Features
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to manage healthcare data efficiently and securely.
                </p>
              </motion.div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <p className="mt-2 opacity-90">Enhanced Healthcare Delivery</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
