...
export default function HospitalCCTVPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Compliant with healthcare security regulations and industry best practices."
    },
    {
      icon: Zap,
  ...
  const benefits = [
    ...
    "Scalable for hospital facilities"
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Comprehensive CCTV surveillance solutions for hospitals featuring AI-powered analytics, real-time monitoring, and compliance with healthcare security standards."
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/hospital-cctv-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Hospital CCTV Systems</h3>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to meet the unique security challenges of healthcare environments.
                </p>
              </motion.div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <p className="mt-2 opacity-90">Comprehensive Protection for Healthcare</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
