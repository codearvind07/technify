  ...
  const features = [
    {
      ...
      description: "Intelligent queue allocation with real-time monitoring and dynamic adjustments."
    },
    {
      icon: Timer,
      title: "Wait Time Reduction",
      description: "Advanced algorithms to minimize patient wait times and optimize flow."
    },
    {
      icon: Monitor,
      title: "Digital Display Systems",
      description: "Real-time queue information displayed on digital screens throughout the facility."
    },
    {
      icon: Smartphone,
      title: "Mobile Integration",
      description: "Mobile app for patients to check queue status and receive notifications."
    }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Queue Management Systems featuring smart queue allocation, real-time monitoring, mobile integration, and analytics to reduce patient wait times and improve healthcare delivery."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Healthcare Operations Solution
                  </motion.div>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/hospital-qms-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Queue Management</h3>
                        <p className="mt-2 opacity-90">Optimized Patient Flow</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to optimize patient flow and reduce wait times in healthcare environments.
                </p>
              </motion.div>
