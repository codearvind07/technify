...
export default function RailwayPASPage() {
  ...
  return (
    <>
      <SEO 
        title="Railway Public Address System (PAS) - Clear Communication Solutions"
        description="Advanced Public Address Systems for railways featuring high-quality audio, IP-based networking, priority override, and zone control for all railway communication needs. railway pas system, metro announcement system, railway audio system, ip pas for railways, station public address system, railway communication solutions"
        ...
        <main>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Clear Announcements. Real-Time Alerts. Reliable Passenger Communication.
                  </motion.p>
                  ...
                  >
                    Railway & metro stations depend heavily on the Public Address System (PAS) for smooth passenger movement and safety. Announcements must be clear, timely, and audible across noisy, crowded platforms. Technify delivers railway-grade PAS systems engineered for high-noise, high-traffic environments with zero downtime.
                  </motion.p>
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
                    <Image
                      src="https://images.unsplash.com/photo-1674565749718-fcd866ca16cb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8UHVibGljJTIwQWRkcmVzcyUyMFN5c3RlbSUyMENsZWFyJTIwQ29tbXVuaWNhdGlvbiUyMGZvciUyMFJhaWx3YXlzfGVufDB8fDB8fHww"
                      alt="Railway Public Address System"
                      width={600}
                      height={400}
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                      ...
                      <p className="mt-2 opacity-90">Clear Communication for Railways</p>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Railway operations rely on continuous communication for:
                </p>
              </motion.div>
              ...
              >
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Any failure in the PAS directly impacts passenger safety and station efficiency.
                </p>
              </motion.div>
            </div>
          </section>
                      ...
                      <div className="flex-1">
                        ...
                        {index === 0 && (
                          <p className="mt-4 text-gray-600 italic">
                            Ensures zero delay audio across long platforms.
                          </p>
                        )}
                        {index === 1 && (
                          <p className="mt-4 text-gray-600 italic">
                            Optimized for clear sound in noisy environments.
                          </p>
                        )}
                        {index === 3 && (
                          <p className="mt-4 text-gray-600 italic">
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-blue-50">
            <div className="max-w-7xl mx-auto">
              ...
              >
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Creates a connected communication ecosystem across stations.
                </p>
              </motion.div>
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border-8 border-white">
                    <Image
                      src="https://images.unsplash.com/photo-1664724852805-7c4b45522f70?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="PAS System Components"
                      width={600}
                      height={400}
                      className="object-cover w-full h-96"
                    />
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                      ...
                      <p className="mt-2 opacity-90">Complete PAS Infrastructure</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    Our Public Address System includes all essential components for comprehensive railway communication.
                  </motion.p>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
            <div className="max-w-5xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Improve Railway Communication?</h2>
                <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto opacity-90">
                  Contact our experts to discuss how our Public Address System can enhance communication at your railway network.
                </p>
