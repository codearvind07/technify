  ...
  const features = [
    {
      ...
      description: "Crystal-clear displays for information, advertising, and entertainment in station areas."
    },
    {
      icon: Video,
    ...
    },
    {
      ...
      description: "Advanced visualization systems for railway operations and security monitoring."
    }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Audio-Visual Solutions for railways featuring high-definition displays, video conferencing, audio systems, and control room solutions for enhanced passenger experience and operations."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Comprehensive audio-visual systems designed to enhance the passenger experience, support railway operations, and provide effective communication throughout station facilities.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/railway-av-brochure.pdf" 
                      download
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to deliver exceptional audio-visual experiences throughout railway facilities.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <p className="mt-2 opacity-90">Versatile AV Solutions for Railways</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    Our Audio-Visual Solutions are designed for a wide range of applications throughout railway facilities.
                  </motion.p>
