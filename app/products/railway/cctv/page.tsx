...
export default function RailwayCCTVPage() {
  ...
  const features = [
    {
      ...
      description: "Advanced video analytics for real-time threat detection and automated alerts."
    },
    {
      icon: Shield,
      title: "High Security Standards",
      description: "Compliant with railway security regulations and industry best practices."
    },
    {
      icon: Zap,
      title: "Real-Time Monitoring",
      description: "24/7 live monitoring with instant notifications for security events."
    },
    {
      icon: Cloud,
      title: "Cloud Integration",
      description: "Secure cloud storage with easy access to recorded footage from anywhere."
    }
  ];
  ...
  const benefits = [
    ...
    "Scalable for stations and tracks"
  ];

  return (
    <>
      <SEO 
        title="Railway CCTV Surveillance Systems - Advanced Security Monitoring"
        description="Comprehensive CCTV surveillance solutions for railways featuring AI-powered analytics, real-time monitoring, and compliance with railway security standards."
        path="/products/railway/cctv"
        image="/images/og-railway-cctv.jpg"
      />
        ...
        <main>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Advanced surveillance solutions designed specifically for railway environments to enhance security, monitor operations, and ensure passenger safety.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/railway-cctv-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Railway CCTV Systems</h3>
                        <p className="mt-2 opacity-90">Advanced Surveillance Solutions</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to meet the unique security challenges of railway environments.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Security Benefits</h3>
                        <p className="mt-2 opacity-90">Comprehensive Protection for Railways</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    Our CCTV surveillance systems provide comprehensive security coverage tailored for railway environments.
                  </motion.p>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-800">
            <div className="max-w-5xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Enhance Railway Security?</h2>
                <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
                  Contact our experts to discuss how our CCTV surveillance systems can protect your railway network.
                </p>
