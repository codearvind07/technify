...
export default function RailwayFireAlarmPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Full railway coverage with strategically placed detectors and notification devices."
    },
    {
      icon: Wifi,
      title: "Network Integration",
      description: "IP-based system with remote monitoring and integration with other railway systems."
    },
    {
      icon: Battery,
      title: "Backup Power",
  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Fire Alarm Systems for railways featuring early detection, comprehensive coverage, network integration, and backup power for maximum safety compliance."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Comprehensive fire detection and alarm systems designed specifically for railway environments to ensure maximum safety for passengers and staff.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/railway-fire-alarm-brochure.pdf" 
                      download
