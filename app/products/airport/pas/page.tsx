  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Public Address Systems for airports featuring high-quality audio, IP-based networking, priority override, and zone control for all airport communication needs."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Reliable and high-quality audio communication systems designed for airport environments to ensure clear announcements and emergency notifications.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/airport-pas-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        <Volume2 className="w-24 h-24 mx-auto mb-6" />
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        <Mic className="w-24 h-24 mx-auto mb-6" />
