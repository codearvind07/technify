...
export default function AirportCCTVPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Compliant with aviation security regulations and industry best practices."
    },
    {
      icon: Zap,
  ...
  const benefits = [
    ...
    "Scalable for terminals and runways"
  ];

  return (
    <>
      <SEO 
        title="Airport CCTV Surveillance Systems - Advanced Security Monitoring"
        description="Comprehensive CCTV surveillance solutions for airports featuring AI-powered analytics, real-time monitoring, and compliance with aviation security standards."
        ...
        <main>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Advanced surveillance solutions designed specifically for airport environments to enhance security, monitor operations, and ensure passenger safety.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/airport-cctv-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Airport CCTV Systems</h3>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to meet the unique security challenges of airport environments.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <p className="mt-2 opacity-90">Comprehensive Protection for Airports</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  >
                    Our CCTV surveillance systems provide comprehensive security coverage tailored for airport environments.
                  </motion.p>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-blue-800">
            <div className="max-w-5xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Enhance Airport Security?</h2>
                <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto opacity-90">
                  Contact our experts to discuss how our CCTV surveillance systems can protect your airport.
                </p>
