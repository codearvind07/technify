  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced Fire Alarm Systems for airports featuring early detection, comprehensive coverage, network integration, and backup power for maximum safety compliance."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Comprehensive fire detection and alarm systems designed specifically for airport environments to ensure maximum safety for passengers and staff.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/airport-fire-alarm-brochure.pdf" 
                      download
