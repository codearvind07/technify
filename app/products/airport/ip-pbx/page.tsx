  ...
  const features = [
    {
      ...
      description: "Seamless integration of voice, video, and messaging across all airport departments."
    },
    {
      icon: Wifi,
  ...
  return (
    <>
      <SEO 
        ...
        description="Advanced IP PBX and Communication Systems for airports featuring unified communications, IP-based infrastructure, high availability, and centralized management for seamless operations."
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    Advanced IP-based communication systems designed to streamline airport operations with reliable voice, video, and data communication across all departments.
                  </motion.p>
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/airport-ip-pbx-brochure.pdf" 
                      download
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to ensure reliable and efficient communication throughout airport facilities.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  >
                    Our IP PBX & Communication System provides comprehensive communication capabilities for all airport operations.
                  </motion.p>
