  ...
  const features = [
    {
      ...
      description: "High-definition video conferencing solutions for seamless collaboration across locations."
    },
    {
      icon: Speaker,
      title: "Sound Systems",
      description: "Professional audio systems for conference rooms, auditoriums, and presentation spaces."
    },
    {
      icon: Tv,
      title: "Digital Signage",
      description: "Dynamic digital signage solutions for corporate communications and wayfinding."
    },
    {
      icon: Video,
      title: "Content Management",
      description: "Centralized content management for all AV systems with scheduling and remote control."
    }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Comprehensive AV solutions for enterprises featuring video conferencing, sound systems, digital signage, and content management for enhanced collaboration and communication."
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/enterprise-av-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Audio-Visual Systems</h3>
                        <p className="mt-2 opacity-90">Enhanced Collaboration & Communication</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to enhance communication and collaboration in enterprise environments.
                </p>
              </motion.div>
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        <Speaker className="w-24 h-24 mx-auto mb-6" />
                        <h3 className="text-2xl font-bold">AV Benefits</h3>
                        <p className="mt-2 opacity-90">Enhanced Communication & Collaboration</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
