...
export default function EnterpriseCCTVPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Compliant with enterprise security regulations and industry best practices."
    },
    {
      icon: Zap,
  ...
  const benefits = [
    ...
    "Employee and asset safety monitoring",
    "Integration with access control systems",
    "Mobile app for remote monitoring",
    "Scalable for enterprise facilities"
  ];
  ...
  return (
    <>
      <SEO 
        ...
        description="Comprehensive CCTV surveillance solutions for enterprises featuring AI-powered analytics, real-time monitoring, and compliance with security standards."
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  >
                    ...
                    <a 
                      href="/pdf/enterprise-cctv-brochure.pdf" 
                      download
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-700 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold">Enterprise CCTV Systems</h3>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Cutting-edge technology designed to meet the unique security challenges of enterprise environments.
                </p>
              </motion.div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl border border-gray-200">
                    <div className="bg-gradient-to-br from-blue-600 to-blue-800 w-full h-96 flex items-center justify-center">
                      <div className="text-white text-center p-8">
                        ...
                        <p className="mt-2 opacity-90">Comprehensive Protection for Enterprise</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
